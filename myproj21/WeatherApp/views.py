...
import requests
from .serializers import Weatherseralizers
import datetime
...
def application(request):
    try:
        ...
        serializer=Weatherseralizers(y,many=True)
        l=serializer.data
        try:
        ...
        return HttpResponse("<html><body> <h1 align='center'> City not found </h1> <h2> Check the spelling of your city and try again </h2> </body></html>")
